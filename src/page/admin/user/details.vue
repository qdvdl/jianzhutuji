  ...
  <div>
     <div class="user">
       <el-row  :gutter="0">
         ...
         <el-col :span="11"><div class="user-info setinfo"><strong>用户姓名：</strong>{{!data.name ? '--': data.name }}</div></el-col>
       </el-row>

       <el-row  :gutter="0">
         <el-col :span="1"> <div class="user-info"></div> </el-col>
         <el-col :span="12"><div class="user-info setinfo"><strong>年龄：</strong>{{!data.age? '--': data.age }}</div></el-col>
         <el-col :span="11"><div class="user-info setinfo"><strong>身份证号：</strong>{{!data.cardid? '--': data.cardid }}</div></el-col>
       </el-row>
       <el-row  :gutter="0">
         <el-col :span="1"> <div class="user-info"></div> </el-col>
         <el-col :span="12"><div class="user-info setinfo"><strong>是否是工人：</strong>{{data.wstatet}}</div></el-col>
         <el-col :span="11"><div class="user-info setinfo"><strong>是否是包工：</strong>{{data.cstatet}}</div></el-col>
       </el-row>
       <el-row  :gutter="0">
         <el-col :span="1"> <div class="user-info"></div> </el-col>
...
<script>
  ...
  export default {
    ...
    mounted(){
     this.resetload({id:this.data.id});
    },
    methods:{
      resetload(data){
