    ...
    methods:{
      ...
      confirmOperation(msg,data){
        this.$confirm(msg, '提示', {
          ...
          this.postData(data,this.$api.frozenThaw);
        }).catch(() => {
          this.$message({
            type: 'info',
            message: '已取消操作'
      ...
      columns(){
        let c=[
          ...
          {prop:"typetext",name:"工种",minWidth:200,isShowType:"default"},
          {prop:"num",name:"接单数量",minWidth:170,isShowType:"default"},
          {prop:"staynum",name:"未到岗次数",minWidth:170,isShowType:"default"},
          {prop:"audittext",name:"审核状态",minWidth:170,isShowType:"default"},
          {prop:"statetext",name:"工人状态",minWidth:170,isShowType:"default"},
